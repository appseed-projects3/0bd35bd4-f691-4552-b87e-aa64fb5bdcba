...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-11 06:03`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0bd35bd4-f691-4552-b87e-aa64fb5bdcba.git
$ cd 0bd35bd4-f691-4552-b87e-aa64fb5bdcba
```
